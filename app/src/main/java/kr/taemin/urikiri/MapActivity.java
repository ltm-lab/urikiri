...
public class MapActivity <findViewById> extends AppCompatActivity implements MapView.CurrentLocationEventListener, MapView.MapViewEventListener, MapView.OpenAPIKeyAuthenticationResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.setDaumMapApiKey("ccbe5c8e90038c29dca80f69bd66611b");
        ...
        final boolean[] isPageOpen = {false};
        Button button = findViewById(R.id.sliding_button);
        ViewGroup page = findViewById(R.id.page);

        Animation translateBelow = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.translate_below);
        Animation translateTop = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.translate_top);
        ...
        translateBelow.setAnimationListener(listener);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isPageOpen[0]) {
                    page.startAnimation(translateBelow);
                } else {
                    page.setVisibility(View.VISIBLE);
                    page.startAnimation(translateTop);
                }
            }
        });
